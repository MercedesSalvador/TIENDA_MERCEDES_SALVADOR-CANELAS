...
<main class = "col-md-9 ms-sm-auto col-lg-10 px-md-4">  
 <form  action="<%=request.getContextPath()%>/actualizarPedido" method="post">
	<div class="form-row">
  
    <h1 id="iniciarSesion" class="h3 mb-3 fw-normal">Editar Pedido</h1>
    
	
	<input type="hidden" id="id" name="id" value="<%= p.getId() %>"/>
			<div class="form-group col-md-4">
                <label for="Cedula">ID Pedido</label>
                <input type="text" name="nombre" class="form-control" value="<%= p.getId() %>" disabled>
            </div>
            <div class="form-group col-md-4">
                <label for="id_usuario">ID Usuario</label>
                <input type="text" name="id_usuario" class="form-control" value="<%= p.getId_usuario() %>" disabled>
            </div>
            <div class="form-group col-md-4">
             	<label for="Cedula">Estado Pedido</label>
						<select name="estado" class="form-control" value="<%= p.getEstado()%>">
