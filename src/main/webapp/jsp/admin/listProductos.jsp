...
<a  href="<%=request.getContextPath()%>/crearProductoAdmin" type="button" class="btn btn-light text-dark me-2">Crear Producto</a>
 ...
 <tbody>
   <tr>
	   ...
	   <td>
	   	<div class="line">
			<div class="form-group row">
				<a class="btn btn-secondary" href="<%=request.getContextPath()%>/editarProductoAdmin?op=edit&id=<%=p.getId()%>">
                   Editar
                </a>
            </div>
        </div>
	   ...
	   <td>
	   	<div class="line">
			<div class="form-group row">
				<a class="btn btn-secondary" href="<%=request.getContextPath()%>/editarProductoAdmin?op=remove&id=<%=p.getId()%>">
					Eliminar
                </a>
            </div>
        </div>
