  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
     ...
     <div class="text-center">
        <br>
        <br>
        <h1 style="color: #94B3AD">Bienvenido a la aplicación de gestión de nuestra tienda!</h1>
		<br>
		<br> <i class="fas fa-users-cog fa-9x" style="color: #94B3FD"></i><br>
		<br>
