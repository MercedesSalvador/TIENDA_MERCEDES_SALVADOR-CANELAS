...
<a  href="<%=request.getContextPath()%>/altaUsuarioAdmin" type="button" class="btn btn-light text-dark me-2">Crear Usuario</a>
<h3>Clientes</h3>
...
if(listado_Usuarios!=null) {
    for(int i=0; i<listado_Usuarios.size(); i++) {
	   ...
	   <tr>
		   ...
		   <td><%=us.getDni() %></td>
		   <td><%=us.getCalle() %></td>
		   <td><%=us.getLocalidad() %></td>
		   <td><%=us.getProvincia() %></td>
		   ...
		   <td>
		   	<div class="line">
				<div class="form-group row">
					<a class="btn btn-secondary" href="<%=request.getContextPath()%>/opUsuarioAdmin?op=edit&id=<%=us.getId()%>">
	                  Editar
	                </a>
	            </div>
	        </div>
	   	   ...
	   	   <td>
		   	<div class="line">
				<div class="form-group row">
					<a class="btn btn-secondary" href="<%=request.getContextPath()%>/opUsuarioAdmin?op=remove&id=<%=us.getId()%>">
	                  Eliminar
	                </a>
	            </div>
	        </div>
