...
<form  action="<%=request.getContextPath()%>/actualizarUsuarioAdmin" method="post">
<h3>Editar Usuario</h3>
        <div class="form-row">
            ...
            <div class="form-group col-md-4">            
                ...
                <input type="text" name="apellido1" class="form-control" value="<%=u.getApellido1()%>">
            </div>
            <div class="form-group col-md-4">
                <label for="Cedula">Segundo Apellido</label>
                <input type="text" name="apellido2" class="form-control" value="<%=u.getApellido2()%>">
            </div>
            <div class="form-group col-md-4">            
                <label for="Cedula">DNI</label>
                <input type="text" name="dni" class="form-control" value="<%=u.getDni()%>">
            </div>
            <div class="form-group col-md-4">
                <label for="Cedula">Calle</label>
                <input type="text" name="calle" class="form-control" value="<%=u.getCalle()%>">
            </div>
            <div class="form-group col-md-4">
                <label for="Cedula">Localidad</label>
                <input type="text" name="localidad" class="form-control" value="<%=u.getLocalidad()%>">
            </div>
            <div class="form-group col-md-4">
                <label for="Cedula">Provincia</label>
				<input type="text" name="provincia" class="form-control" value="<%=u.getProvincia()%>">	
            </div>
			<div class="form-group col-md-4">
			...
			<div class="form-group col-md-4">
				...
				<input type="password" name="clave" class="form-control" value="<%=u.getClave()%>" disabled>	
            </div>
